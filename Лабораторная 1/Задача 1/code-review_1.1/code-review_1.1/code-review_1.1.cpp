...
int main() {
    ...
    * 2. Google Style Guide рекомендует \n вместо std::endl
    * 3. Присутствуют строки длиннее 80 символов
    * 4. Много лишних пустых строк (cout << endl;)
    * 5. Открывающиеся скобки были на отдельной строке
    * 6. Отсутствие проверки ввода
    */
    /*srand(time(0));
